...
from muscle_movement.constants import DEFAULT_PASSWORD
from muscle_movement.models import User
import string
...
class ForgotPassword(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if not user:
            ...
            if email_sent:
                user.save()
                self.response_data['message'] = f'Password changed! check email ({user.email})'
            else:
